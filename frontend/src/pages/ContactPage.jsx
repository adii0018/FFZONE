...
const CONTACT_INFO = [
  { icon: FaEnvelope, label: 'Email Us', value: 'support@ffzone.gg', color: '#F97316', href: 'mailto:support@ffzone.gg' },
  ...
  { icon: MdLocationOn, label: 'Based In', value: 'India 🇮🇳', color: '#F97316', href: null },
]
...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-[#050810] pt-24 pb-16 font-sans relative overflow-hidden">
      {/* BG glows */}
      <div className="absolute top-0 left-1/4 w-[700px] h-[500px] bg-[#F97316]/5 rounded-full blur-[150px] pointer-events-none"></div>
      <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] bg-[#F97316]/5 rounded-full blur-[150px] pointer-events-none"></div>
          ...
          <div className="lg:col-span-2 flex flex-col gap-4">
            {CONTACT_INFO.map((item, idx) => (
              <a
                ...
                className="group flex items-center gap-4 bg-white/[0.03] border border-white/10 rounded-xl p-5 hover:border-[#F97316]/40 hover:bg-white/[0.06] transition-all duration-300 cursor-pointer"
              >
                <div
            ...
            <div className="mt-2 bg-white/[0.03] border border-white/10 rounded-xl p-5">
              ...
              <div className="flex gap-3">
                <a href="#" className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-white/50 hover:bg-[#F97316] hover:text-white hover:scale-110 hover:shadow-[0_0_15px_rgba(249,115,22,0.5)] transition-all duration-300">
                  <FaInstagram size={18} />
                </a>
          ...
          <div className="lg:col-span-3 bg-white/[0.03] border border-white/10 rounded-2xl p-8">
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                  <label className="block text-white/60 text-sm font-semibold mb-2">Your Name <span className="text-[#F97316]">*</span></label>
                  <input
                    type="text"
                    name="name"
                    value={form.name}
                ...
                <div>
                  <label className="block text-white/60 text-sm font-semibold mb-2">Email Address <span className="text-[#F97316]">*</span></label>
                  <input
                    type="email"
                    name="email"
                    value={form.email}
              ...
              <div>
                <label className="block text-white/60 text-sm font-semibold mb-2">Message <span className="text-[#F97316]">*</span></label>
                <textarea
                  name="message"
                  value={form.message}
                  onChange={handleChange}
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-lg py-3 px-4 text-white text-sm placeholder:text-white/30 focus:outline-none focus:border-[#F97316] focus:ring-1 focus:ring-[#F97316] transition-all resize-none"
                />
              </div>
              <button
                type="submit"
                disabled={sending}
                className="w-full flex items-center justify-center gap-2 bg-[#F97316] hover:bg-[#ea580c] disabled:opacity-60 text-white font-bold py-3.5 px-6 rounded-lg transition-all transform hover:scale-[1.02] active:scale-[0.98] shadow-[0_4px_20px_0_rgba(249,115,22,0.4)]"
              >
